  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        Favorite recipe for making pizza:
        <ol id="wd-your-favorite-recipe">
          <li>
            Make the dough: Combine flour, yeast, salt, and water, then knead
            the dough.
          </li>
          <li>Let the dough rise for 1-2 hours in a warm place.</li>
          <li>Preheat the oven to 475°F (245°C).</li>
          <li>Roll out the dough into your desired pizza shape.</li>
          <li>Spread pizza sauce evenly over the dough.</li>
          <li>Add toppings like cheese, vegetables, meats, or herbs.</li>
          <li>
            Bake the pizza in the preheated oven for 10-15 minutes, until the
            crust is golden and the cheese is melted.
          </li>
          <li>Remove from the oven, slice, and enjoy!</li>
        </ol>
...
_Starship-gap2.jpg"
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          &nbsp; to reach the code repository on GitHub.
          <br />
        </form>
      </div>
    </div>
